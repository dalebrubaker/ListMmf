...
{
    public class ReadOnlyListMmf<T> : IList64Disposable<T>, IList64, IReadOnlyList64<T> where T : struct
    {
        private readonly IList64Disposable<T> _list;

        public ReadOnlyListMmf(IList64Disposable<T> list)
        {
