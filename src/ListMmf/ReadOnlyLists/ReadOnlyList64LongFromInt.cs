...
public class ReadOnlyList64MmfIntToLong : IReadOnlyList64Mmf<long>
{
    private readonly IReadOnlyList64Mmf<int> _list;
    private readonly string _priceTypeName;

    public ReadOnlyList64MmfIntToLong(IReadOnlyList64Mmf<int> list, string priceTypeName)
    {
        _list = list;
    ...
    {
        [NonSerialized] private readonly ReadOnlyList64MmfIntToLong _list;

        private long _index;

        internal Enumerator(ReadOnlyList64MmfIntToLong list)
        {
            _list = list;
            _index = 0;
            Current = 0;
