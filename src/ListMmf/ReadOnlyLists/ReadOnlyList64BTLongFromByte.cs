...
public class ReadOnlyList64MmfLongFromByte : IReadOnlyList64Mmf<long>
{
    private readonly IReadOnlyList64Mmf<byte> _list;
    private readonly string _priceTypeName;

    public ReadOnlyList64MmfLongFromByte(IReadOnlyList64Mmf<byte> list, string priceTypeName)
    {
        _list = list;
    ...
    {
        [NonSerialized] private readonly ReadOnlyList64MmfLongFromByte _list;

        private long _index;

        internal Enumerator(ReadOnlyList64MmfLongFromByte list)
        {
            _list = list;
            _index = 0;
            Current = 0;
